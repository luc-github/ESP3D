...
#undef ESP_FLAG_SHARED_SD_IDLE_VALUE
...
#define ESP_FLAG_SHARED_SD_IDLE_VALUE HIGH
...
#ifndef ESP_FLAG_SHARED_SD_IDLE_VALUE
#define ESP_FLAG_SHARED_SD_IDLE_VALUE 1
#endif  // ESP_FLAG_SHARED_SD_IDLE_VALUE
