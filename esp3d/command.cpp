...
bool COMMAND::execute_command (int cmd, String cmd_params, tpipe output, level_authenticate_type auth_level, AsyncResponseStream  *asyncresponse)
{
    ...
    case 301:
...
#endif
        {
            ...
            if (CONFIG::read_string (EP_DATA_STRING, sbuf, MAX_DATA_LENGTH) ) {
                BRIDGE::println (sbuf, output, asyncresponse);
            } else {
                BRIDGE::println (F ("Error reading data"), output, asyncresponse);
            }
        }
        break;
    ...
    case 400: {
        ...
        if (cmd_params == "printer" || cmd_params == "") {
            ...
            //Refresh time 1
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_REFRESH_PAGE_TIME), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"B\",\"V\":\""), output, asyncresponse);
            ...
            BRIDGE::print (F ("\",\"H\":\"Temperature Refresh Time\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MAX_REFRESH), output, asyncresponse);
            BRIDGE::print (F ("\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MIN_REFRESH), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
            BRIDGE::println (F (","), output, asyncresponse);

            //Refresh time 2
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_REFRESH_PAGE_TIME2), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"B\",\"V\":\""), output, asyncresponse);
            ...
            BRIDGE::print (F ("\",\"H\":\"Position Refresh Time\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MAX_REFRESH), output, asyncresponse);
            BRIDGE::print (F ("\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MIN_REFRESH), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
            ...
            //XY feedrate
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_XY_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"I\",\"V\":\""), output, asyncresponse);
            ...
            BRIDGE::print (F ("\",\"H\":\"XY feedrate\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MAX_XY_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MIN_XY_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
            BRIDGE::println (F (","), output, asyncresponse);

            //Z feedrate
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_Z_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"I\",\"V\":\""), output, asyncresponse);
            ...
            BRIDGE::print (F ("\",\"H\":\"Z feedrate\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MAX_Z_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MIN_Z_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
            BRIDGE::println (F (","), output, asyncresponse);

            //E feedrate
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_E_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"I\",\"V\":\""), output, asyncresponse);
            ...
            BRIDGE::print (F ("\",\"H\":\"E feedrate\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MAX_E_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (DEFAULT_MIN_E_FEEDRATE), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
            BRIDGE::println (F (","), output, asyncresponse);

            //Camera address, data string
            BRIDGE::print (F ("{\"F\":\"printer\",\"P\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (EP_DATA_STRING), output, asyncresponse);
            BRIDGE::print (F ("\",\"T\":\"S\",\"V\":\""), output, asyncresponse);
            if (!CONFIG::read_string (EP_DATA_STRING, sbuf, MAX_DATA_LENGTH) ) {
                BRIDGE::print ("???", output, asyncresponse);
            } else {
            ...
            BRIDGE::print (F ("\",\"S\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (MAX_DATA_LENGTH), output, asyncresponse);
            BRIDGE::print (F ("\",\"H\":\"Camera address\",\"M\":\""), output, asyncresponse);
            BRIDGE::print ( (const char *) CONFIG::intTostr (MIN_DATA_LENGTH), output, asyncresponse);
            BRIDGE::print (F ("\"}"), output, asyncresponse);
        }
    ...
    case 800: {
        ...
        if (CONFIG::is_direct_sd) {
            ...
            BRIDGE::print (F ("Serial SD"), output, asyncresponse);
        }
        ...
        if (sd_dir == SD_DIRECTORY) {
            BRIDGE::print (F ("/sd/"), output, asyncresponse);
        } else if (sd_dir == EXT_DIRECTORY) {
            BRIDGE::print (F ("/ext/"), output, asyncresponse);
        } else {
    ...
    case 802:
        if (CONFIG::check_update_presence( ) ) {
            BRIDGE::println ("yes", output, asyncresponse);
        } else {
            BRIDGE::println ("no", output, asyncresponse);
        }
        break;
    case 810:
