...
//Allow to excecute flash macro on start
#define AUTO_MACRO_FEATURE
#ifdef AUTO_MACRO_FEATURE
//file name for configuration file on SD Card
#define AUTO_MACRO_FILENAME "/autostart.esp"
#endif
