...
```
        ...
        ESP_NOTIFICATION_TOKEN1 332     //256 bytes 255+1 = string  ; warning does not support multibyte char like chinese   
        ESP_NOTIFICATION_TOKEN2 588     //64 bytes 63+1 = string  ; warning does not support multibyte char like chinese    
        ESP_SENSOR_TYPE         652     //1  bytes = flag   
        ESP_TARGET_FW           653     //1  bytes = flag   
        FREE                    654     //1  bytes = flag   
        FREE                    655     //1  bytes = flag   
        ESP_TIME_SERVER1        656     //129 bytes 128+1 = string  ; warning does not support multibyte char like chinese   
        ESP_TIME_SERVER2        785     //129 bytes 128+1 = string  ; warning does not support multibyte char like chinese   
        ESP_TIME_SERVER3        914     //129 bytes 128+1 = string  ; warning does not support multibyte char like chinese   
        ESP_REMOTE_SCREEN       1043     //1  bytes = flag   
        ESP_SD_MOUNT            1044     //1  bytes = flag   
        ESP_SESSION_TIMEOUT     1045     //1  bytes = flag   
        FREE          FLAG      1046     //1  bytes = flag   
        ESP_SD_CHECK_UPDATE_AT_BOOT 1047//1  bytes = flag   
        ESP_NOTIFICATION_SETTINGS 1048   //129 bytes 128+1 = string  ; warning does not support multibyte char like chinese    
        ESP_CALIBRATION_1       1177     //4  bytes = int   
        ESP_CALIBRATION_2       1181     //4  bytes = int   
        ESP_CALIBRATION_3       1185     //4  bytes = int    
        ESP_CALIBRATION_4       1189     //4  bytes = int   
        ESP_CALIBRATION_5       1193     //4  bytes = int   
        ESP_SETUP               1197    //1 byte = flag    
        FREE                    1198    //1 byte = flag   
        FREE                    1199    //1 byte = flag   
        FREE                    1200    //1 byte = flag   
        ESP_FTP_CTRL_PORT       1201    //4  bytes = int   
        ESP_FTP_DATA_ACTIVE_PORT  1205    //4  bytes = int   
        ESP_FTP_DATA_PASSIVE_PORT 1209    //4  bytes = int   
        ESP_FTP_ON              1213     //1 byte = flag   
        ESP_AUTO_NOTIFICATION   1214    //1 byte = flag   
        ESP_VERBOSE_BOOT	    1215	//1 byte = flag   
        ESP_WEBDAV_ON           1216    //1 byte = flag   
        ESP_WEBDAV_PORT  	    1217	//4  bytes = int   
        ESP_STA_DNS_VALUE       1221    //4  bytes= int    
        ESP_SECURE_SERIAL       1225    //1 byte = flag   
        ESP_SERIAL_BRIDGE_ON    1228    //1 byte = flag
        FREE                    1229    //1 byte = flag
        ESP_SERIAL_BRIDGE_BAUD  1230    //4  bytes= int
        ESP_TIME_ZONE           1234    //7  bytes= string    
```
