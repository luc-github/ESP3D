...
public:
    ...
    static bool execute_command (int cmd, String cmd_params, tpipe output, level_authenticate_type auth_level = LEVEL_GUEST, AsyncResponseStream  *asyncresponse = NULL);
