...
void handle_css()
{
	web_interface->WebServer.sendContent_P(CSS);
}
...
WEBINTERFACE_CLASS::WEBINTERFACE_CLASS (int port):WebServer(port)
{
  ...
  WebServer.on("/mincss.css",HTTP_ANY, handle_css);
  #ifdef SSDP_FEATURE
