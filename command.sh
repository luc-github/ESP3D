...
function build_sketch()
{
    ...
    then
        ...
        arduino --board esp8266com:esp8266:generic:eesz=4M3M,xtal=160,FlashMode=dio,FlashFreq=40,sdk=nonosdk221,ip=lm2f,dbg=Disabled,vt=flash,exception=disabled,ssl=basic,mmu=3232 --save-prefs
    fi
    if [[ "$fs" == "SPIFFS" ]];
    then
